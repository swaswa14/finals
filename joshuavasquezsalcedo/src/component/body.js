    ...
    return(
        <div className="card mt-2 p-2">
            <div className="card-header">
                <h5 className="card-title">My Stacks</h5>
            </div>
            <div className="card-body p-5">
                <div className="row">
                    <div className="col-6 col-lg-3">
                        <div className="count-data text-center">
                            <h6 className="count h2" data-to="500" data-speed="500">⭐⭐⭐⭐⭐</h6>
                            ...
                            <p className="m-0px font-w-600">Java Core</p>
                        </div>
                    </div>
                    ...
                    <div className="col-6 col-lg-3">
                        <div className="count-data text-center">
                            <h6 className="count h2" data-to="150" data-speed="150">⭐⭐⭐⭐⭐</h6>
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48"
                                 viewBox="0 0 48 48">
                                ...
                                <polygon fill="#ebebeb"
                                         points="24.9,32.57 25,32.54 26,35 25,36.72 24.94,36.74 16.61,34.36 16.05,28 20.07,28 20.35,31.27"></polygon>
                                <polygon fill="#fff"
                                         points="34.07,21 32.5,34.42 25,36.72 25,32.54 28.83,31.36 29.57,25 25,25 25,21"></polygon>
                                <polygon fill="#fff"
                                         points="34.92,18 30.93,18 30.67,16 25,16 25,12 34.13,12 34.3,13.26"></polygon>
                            </svg>
                            <p className="m-0px font-w-600">HTML</p>
                        </div>
                    </div>
                    <div className="col-6 col-lg-3">
                        <div className="count-data text-center">
                            <h6 className="count h2" data-to="850" data-speed="850">⭐⭐⭐⭐</h6>
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48"
                                 viewBox="0 0 48 48">
                            ...
                            <p className="m-0px font-w-600">CSS</p>
                        </div>
                    </div>
                    <div className="col-6 col-lg-3">
                        <div className="count-data text-center">
                            ...
                            <p className="m-0px font-w-600">JavaScript</p>
                        </div>
                    </div>
                    <div className="col-6 col-lg-3">
                        <div className="count-data text-center">
                            ...
                            <p className="m-0px font-w-600">Spring-Boot</p>
                        </div>
                    </div>
                    <div className="col-6 col-lg-3">
                        <div className="count-data text-center">
                            ...
                            <p className="m-0px font-w-600">ReactJS</p>
                        </div>
                    </div>
                    <div className="col-6 col-lg-3">
                        <div className="count-data text-center">
                            ...
                            <p className="m-0px font-w-600">Bootstrap</p>
                        </div>
                    </div>
                    <div className="col-6 col-lg-3">
                        <div className="count-data text-center">
                            ...
                            <p className="m-0px font-w-600">Material UI</p>
                        </div>
                    </div>
                </div>
            </div>
